    ...
    return (
        <section className='max-padd-container py-16'>
            <Title
                ...
                title2={"Blog"}
                titleStyles={"pb-10"}
                para={'Stay ahead of fashion trends with styling tips, product reviews, and expert advice helping you shop better'} />
                ...
                {blogs.map((blog) => (
                    <div key={blog.title} className='border-[11px] border-primary overflow-hidden relative'>
                        ...
                        <div className='absolute bottom-4 left-4 text-white text-[15px]'>
                            ...
                            <button className='bg-white/30 py-0.5 p-5 medium-14'>Coninue Reading</button>
                        </div>
                    </div>
                ))}
            </div>
