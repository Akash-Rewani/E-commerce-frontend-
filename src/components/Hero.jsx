...
const Hero = () => {
    return (
        ...
        <section className='max-padd-container sm:bg-hero bg-cover bg-center bg-no-repeat h-[811px] w-full'>

            <div className='flex flex-col h-full justify-center max-w-[777px] pt-8'>
                <h3 className='h3 text-secordary font-paci font-thin '>
                    Fresh Fits for Frostyy Days
                </h3>
                ...
                <div className='flex items-center'>
                    ...
                    <span className='bg-white px-1 inline-block rotate-[-2deg] ml-2.5 !bold-40'>
                        <span className='text-2xl relative bottom-3'>Rs.</span>99.
