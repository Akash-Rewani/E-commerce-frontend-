...
const SideBar = () => {
    ...
    return (
        <div className='mx-auto max-w-[1440px] flex flex-col sm:flex-row'>
            <div className='max-sm:flexCenter max-xs:pb-3 bg-primary m-2 sm:min-w-[20%] sm:min-h-[97vh] rounded-xl'>
                <div className='flex flex-col gap-y-6 max-sm:items-center sm:flex-col pt-4 sm:pt-14'>
                    <Link to={'/admin'} className='bold-20 md:bold-24 font-paci lg:pl-[15%] text-2xl sm:text-3xl lg:text-4xl'>
                        Bazario <span className='text-secondary bold-28'>.</span>
                    </Link>
                            ...
                            <NavLink to={link.path} key={link.label} end={link.path === '/admin'}
                                className={({ isActive }) =>
                                    isActive
                                        ...
                                        : "flexStart gap-x-2 lg:pl-12 medium:15 cursor-pointer h-10 rounded-xl"} >
                                {link.icon}
