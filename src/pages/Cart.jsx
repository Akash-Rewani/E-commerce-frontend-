            ...
            <div className='flex flex-col xl:flex-row gap-20 xl:gap-28'>
                <div className='flex flex-[2] flex-col gap-3 text-[95%]'>
                    ...
                    {cartData.map((item, i) => {
                        ...
                        const qauntity = cartItems[item._id][item.size]
                        return (
                            <div key={i} className='grid grid-cols-[6fr_1fr_1fr] text-base font-medium bg-white p-2'>
                                <div className='flex items-center md:gap-6 gap-3'>
                                    <div className='flex bg-primary'>
                                        <img src={product.image[0]} alt="productImg" className='w-20' />
                                    </div>
                                    <div>
                                ...
                                <p className='text-center'>{currency}{product.offerPrice * qauntity}</p>
                                <button onClick={() => updateQuantity(item._id, item.size, 0)} className='cursor-pointer mx-auto'>
                ...
                <div className='flex-1 flex-col'>
                    <div className='max-w-[360px] w-full bg-white p-5 py-10 max-md:mt-16'>
                        <CartTotal />
                        <button onClick={()=>navigate('/place-order')} type='submit' className='btn-dark w-full mt-8'>
                                Proceed to Delivery
                        </button>
                    </div>
                </div>
