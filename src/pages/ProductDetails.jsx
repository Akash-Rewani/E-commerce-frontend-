                ...
                <div className='flex gap-10 flex-col xl:flex-row my-6'>
                    ...
                    <div className='flex-1 px-5 py-3 bg-white'>
                        ...
                        <div className='h4 flex items-baseline gap-4 my-2'>
                            ...
                            <h4 className='h4'>{currency}{product.offerPrice}.00</h4>
                        </div>
                        ...
                        <div className='flex flex-col gap-4 my-4 mb-5'>
                            <div className='flex gap-2'>
                                {[...product.sizes].sort((a, b) => {
                                    ...
                                    <button key={i} onClick={() => setSize(item)} className={`${item === size
                        ...
                        <div className='flex items-center gap-x-4'>
                            ...
                            <button className='btn-light'><TbHeart className='text-xl text-pink-500' /></button>
                        </div>
